...
import org.ucombinator.dalvik.vmrelated.{APISpecs, DalvikVMRelated}
import org.ucombinator.utils.{AIOptions, AnalysisScope, AnalysisType, CommonUtils}
...
object PlayHelper extends ParserHelper with DalvikVMRelated {
  ...
  def parseParameters(kStrO: Option[Int], gcStrO: Option[String], doStateCutoffO: Option[String], stateCutoff: Int,
                      doTimeCutoffO: Option[String], timeCutoff: Int, // verboseO: Option[String],
                      path: String, doRegexO: Option[String], regexStr: String, doCheckListO: Option[String], pl: PropertyCheckList
                      /* fs:String, loc:String, pic:String, dev:String, net:String */): List[String] = {
