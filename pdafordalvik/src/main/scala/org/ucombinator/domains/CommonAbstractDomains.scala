...
import org.ucombinator.godelhash.numbertheory.{PrimeHashable, PrimeTable}
 ...
 */
  ...
  object Addr extends PrimeTable[Addr] {
    //with Canonicalizer[Loc] with EqualityOrder[Loc] {
...
*/
  ...
  object Value extends PrimeTable[Value]

  //with Canonicalizer[Val]
  trait Value extends PrimeHashable {
    //with Ordered[Val] {
